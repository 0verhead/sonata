...
updated: 2026-01-17T16:46:50.865Z
---

## Summary

Add a GitHub Actions CI workflow that runs build, typecheck, and lint checks on pushes to `main` and all pull requests, testing across multiple Node.js versions (20, 22) with npm dependency caching.

## Tasks

- [x] Create `.github/workflows/` directory structure
- [x] Create `ci.yml` workflow with trigger on `push` to `main` and `pull_request` events
- [x] Configure Node.js version matrix (20, 22)
...
- Workflow tests against Node.js 20 and 22
...
When the CI workflow file exists at `.github/workflows/ci.yml` and successfully runs build, typecheck, and lint across Node.js 20 and 22 on both push-to-main and PR events, with dependency caching enabled.
